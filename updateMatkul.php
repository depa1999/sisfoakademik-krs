...
if (isset($_POST['cari'])){
	...
	$sql="select * from matkul where idmatkul like'%$cari%' or
                                  namamatkul like '%$cari%' or
                                        sks like '%$cari%' or
                                         jns like '%$cari%' or
            smt like '%$cari%' limit $awalData,$jmlDataPerHal";
}else{
...
?>
<div class="utama">
	<h2 class="text-center" style="margin-top: 2cm;">Daftar Mata Kuliah </h2>
	...
	<span class="float-right">
		<form action="" method="post" class="form-inline">
			...
			<input class="form-control mr-2 ml-2" type="text" name="cari" placeholder="cari data mahatkul..." autofocus autocomplete="off">
		</form>
	</span>
	<br><br>
	<ul class="pagination">
