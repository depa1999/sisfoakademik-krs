...
<body onload="kode_klp_klik()">
	...
	?>
	<div class="utama">
		<h2 class="mb-3 text-center" style="margin-top: 2cm;">EDIT PENAWARAN MATA KULIAH</h2>	
		<form action="sv_editKulTawar.php" method="post">
			...
			<div class="form-group">
				...
				<input type="hidden" id="klp" value="<?php echo $row['kklp']?>">
				<script>
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="kapasitas" id="kapasitas" value="<?php echo $row['kapasitas']?>">
			</div>
