...
<body>
	...
	?>
	<div class="container">
		<h2 class="mb-5 text-center" style="margin-top: 2cm;">GANTI FOTO MAHASISWA</h2>	
		<div class="row">
			<div class="col-sm-4">
			...
			<div class="col-sm-8">
				<form class="form-inline" method="post" action="savefoto.php" enctype="multipart/form-data">				 
