...
<body>
	...
	?>
	<div class="utama">
		<h2 class="mb-3 text-center" style="margin-top: 2cm;">EDIT DATA DOSEN</h2>			
			<form method="post" action="sv_editDosen.php">
				<div class="form-group">
					<label for="npp">NPP:</label>
					<input class="form-control-ku col-md-3" type="text" name="npp" id="npp" value="<?php echo $row['npp']?>" readonly>					
				</div>
				<div class="form-group">
